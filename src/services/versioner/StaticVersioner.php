 ...
 * Static Versioner
 * 
 * A class to handle the scanning and versioning of static files, usually 
 ...
 * @since     1.0.0
 */
class StaticVersioner extends BaseVersioner
{
    ...
    private function createVersions($paths, $dry_run = false): array
    {
        ...
        $prefix = FileVersioner::getInstance()->getSettings()->staticVersioningPrefix;
        if ($prefix) {
    ...
    /**
     * Search a particular directory recursively for files to version,
     * respecting our extension settings and excluding already-versioned
     * files
     * 
    ...
    private function searchDir($dir): array
    {
        ...
        //   out extensions 
        $extensions = FileVersioner::getInstance()->getSettings()->staticVersioningExtensions;
    ...
    private function getDefaultDirs(): array
    {
        ...
        $volumes = FileVersioner::getInstance()->volumes->getAllVolumes();
